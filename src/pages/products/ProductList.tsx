          ...
          <tbody>
            {sortedProducts.map((product) => (
              <tr key={product.id} className="border-b hover:bg-gray-50">
                ...
                <td className="p-3">{persianCategory(product.category)}</td>
                <td className="p-3">{product.price.toLocaleString('fa-IR')}</td>
                <td className="p-3">{product.discount.toLocaleString('fa-IR')}%</td>
                <td className="p-3">
          ...
          <div key={product.id} className="bg-white rounded-lg shadow p-4">
            <div className="flex gap-4">
              <img
                src={product.image}
                alt={product.title}
                className="w-20 h-20 object-cover rounded ml-5"
              />
              <div className="flex-1">
                <h3 className="font-bold text-sm">{product.title}</h3>
                <p className="text-xs text-gray-600 py-1">{persianCategory(product.category)}</p>
