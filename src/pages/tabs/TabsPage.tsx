...
const TabsPage = () => {
  ...
  const tabs = [
    { id: 'content', label: 'محتوا (Content)', icon: <NotebookPen size={18} />},
    { id: 'media', label: 'رسانه (Media)', icon: <Image size={18} />},
    { id: 'management', label: 'مدیریت (Management)', icon: <Settings size={18} />},
  ];
    ...
    <div className="min-h-screen bg-gray-100 p-4" dir="rtl">
      <div className="container mx-auto">
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          ...
          <div className="p-4">
            {activeTab === 'content' && <ContentTab initialSubtab={searchParams.get('subtab') || undefined} />}
            {activeTab === 'media' && <MediaTab initialSubtab={searchParams.get('subtab') || undefined} />}
            {activeTab === 'management' && <ManagementTab initialSubtab={searchParams.get('subtab') || undefined} />}
          </div>
        </div>
      </div>
    </div>
